...
\hypersetup{unicode=true,
  ...
  pdfcopyright={Copyright {\copyright} 2019 by John Sauter},
  pdfdate={2019-05-19},
...
\embedfile[desc={Return the current time including nanoseconds},
  mimetype={text/plain}]{time_current_tm_nano.c}
...
\embedfile[desc={Sleep until the specified time},
  mimetype={text/plain}]{time_sleep_until.c}
...
\embedfile[desc={Compute the number of seconds between two times},
  mimetype={text/plain}]{time_diff.c}
...
\embedfile[desc={Convert Coordinated Universal Time to local time},
  mimetype={text/plain}]{time_utc_to_local.c}
...
\embedfile[desc={Convert local time to Coordinated Universal Time},
  mimetype={text/plain}]{time_local_to_utc.c}
...
\embedfile[desc={Return the current time in a tm structure},
  mimetype={text/plain}]{time_current_tm.c}
...
\embedfile[desc={Convert a time to an integer},
  mimetype={text/plain}]{time_tm_to_integer.c}
...
\embedfile[desc={Convert a time to a 128-bit integer},
  mimetype={text/plain}]{time_tm_nano_to_integer.c}
...
\embedfile[desc={Convert a 128-bit integer to a string},
  mimetype={text/plain}]{int128_to_string.c}
...
\embedfile[desc={Copy a time value from one tm structure to another},
  mimetype={text/plain}]{time_copy.c}
...
\embedfile[desc={Change the year, month, day, hour, minute or second
  of a UTC time value},
  mimetype={text/plain}]{time_utc_add.c}
...
\embedfile[desc={Determine the length of the current or previous
  month or minute},
  mimetype={text/plain}]{time_length.c}
...
\embedfile[desc={Make sure all of the fields of a tm structure
  ...
  mimetype={text/plain}]{time_utc_normalize.c}
...
\embedfile[desc={Change the year, month, day, hour, minute or second
  ...
  mimetype={text/plain}]{time_local_add.c}
...
\embedfile[desc={Make sure all of the fields of a tm structure
  ...
  mimetype={text/plain}]{time_local_normalize.c}
...
\embedfile[desc={Convert a time to a string},
  mimetype={text/plain}]{time_tm_to_string.c}
...
\embedfile[desc={Convert a precise time to a string},
  mimetype={text/plain}]{time_tm_nano_to_string.c}
...
\inputminted[firstline=37,lastline=265]{c}{time_subroutines.h}
\embedfile[desc={Header file for time subroutines},
  mimetype={text/plain}]{time_subroutines.h}

\section{Python}
If you are a Python user, you need to call these subroutines
from Python.  You can do this using {\ttfamily ctypes}.  Write a module
to define the interface, as follows:
\inputminted[firstline=28,lastline=363]{Python}{time_subroutines.py}
\embedfile[desc={Module for calling time subroutines from Python},
  mimetype={text/plain}]{time_subroutines.py}
...
\embedfile[desc={Demonstration Python script},
  mimetype={text/plain}]{demo_python.py}

Note that you cannot use the Python datetime module, since it does
not support leap seconds.  Use these subroutines instead.
...
\embedfile[desc={test the Python interface},
  mimetype={text/plain}]{test_python_interface.py}
...
\embedfile[desc={Example code for periodic backups},
  mimetype={text/plain}]{example_02.c}
...
\embedfile[desc={Example code for rocket over Central Park},
  mimetype={text/plain}]{example_03.c}
...
\embedfile[desc={Example code for International Atomic Time},
  mimetype={text/plain}]{example_04.c}
...
\embedfile[desc={Example code for PTP}
  mimetype={text/plain}]{example_05.c}
...
\embedfile[desc={Example Python code for PTP}
  mimetype={text/plain}]{example_06.py}
...
\item[2019-04-28 3:0:0] Add support for Python.  Int128\_to\_string
  takes its value argument by reference instead of by value.
