...
\inputminted[firstline=37,lastline=269]{c}{time_subroutines.h}
...
\embedfile[desc={Test program},
  mimetype={text/plain}]{test_JDN.c}
\embedfile[desc={Test program},
...
\begin{description}
\item[2019-11-06 3:14:0]Simplify the Makefile and clean up the
  test programs for rpmbuild.  Include a spec file in the tarball
  for two RPMs: libtime and libtime-devel.
