...
of your program.
\inputminted[firstline=45,lastline=69]{c}{tests/test_for_disabled_adjtimex.c}
\embedfile[desc={Complain if adjtimex is not working},
  mimetype={text/plain}]{tests/test_for_disabled_adjtimex.c}
This subroutine is not part of the {\ttfamily libtime} library,
but it is embedded in this PDF file along with the other test programs.
Feel free to express your own feelings in the text of the message.
...
\inputminted[firstline=27,lastline=92]{Python}{tests/demo_python.py}
...
the library, include files and documentation, including
this PDF file.  Your users can install libtime to get just
...
\item[2019-11-29 3:17:0]Add a test for adjtimex not working.
  Mock bug reported in bugzilla 1778298.
