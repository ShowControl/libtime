...
so by 1972 the two time scaled differed by about 10 seconds.  During 1971 the
...
increases by one second.  During 2017, the difference has been 37 seconds.
...
seconds between two times easy: just subtract the integers.  The tradeoff
is that displaying the time in UTC is more difficult.  For example,
the TAI integer \num{1483228836} corresponds to December 31, 2016, at 23:59:60.
...
\inputminted[firstline=41,lastline=68]{c}{example_04.c}
