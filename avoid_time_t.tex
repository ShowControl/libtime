...
\embedfile[desc={Module for calling time subroutines from Python},
  mimetype={plain/Python}]{time_subroutines.py}
...
\embedfile[desc={Demonstration Python script},
  mimetype={plain/Python}]{demo_python.py}
...
\embedfile[desc={program to check the subroutines work},
  mimetype={plain/x-c}]{check_time.c}
...
\embedfile[desc={Automake driver for check and distcheck},
  mimetype={text/bash}]{test-driver}
\embedfile[desc={compare check\_time output with expected output},
  mimetype={text/bash}]{verify_files_template.sh}
...
\embedfile[desc={test the Python interface},
  mimetype={text/Python}]{test_python_interface.py}
...
\embedfile[desc={Example code for International Atomic Time},
  mimetype={text/x-c}]{example_04.c}
...
\embedfile[desc={Example code for PTP}
  mimetype={text/x-c}]{example_05.c}
