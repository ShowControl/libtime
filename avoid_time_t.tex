...
SmallCapsFeatures={Numbers=Lowercase}]{NewCM10-Regular.otf}
...
SmallCapsFeatures={Numbers=Lowercase}]{NewCMSans10-Regular.otf}

\setmonofont[ItalicFont=NewCMMono10-Italic.otf,%
Numbers=Lowercase,%
BoldFont=NewCMMono10-Bold.otf,%
BoldItalicFont=NewCMMono10-BoldOblique.otf,%
SmallCapsFeatures={Numbers=Lowercase}]{NewCMMono10-Regular.otf}

\setmathfont{NewCMMath-Regular.otf}

\addfontfeatures{Renderer=Harfbuzz}
\newcommand{\filename}{\ttfamily\smaller}
...
The data type {\ttfamily time\_t} is defined in POSIX\citep{10555529}
...
\begin{description}
  \item[Note:]
    ...
    The first term adds a day every \num[mode=text]{4} years starting in 1973,
    the second
    subtracts a day back out every \num[mode=text]{100} years starting in 2001,
    and the third adds a day back in every \num[mode=text]{400} years starting
    in 2001.
...
\item{An application using {\ttfamily time\_t} is required to pretend that
  all days
  contain exactly \num[mode=text]{86400} seconds.
  This is false: December 31, 2016, for
  example, contains \num[mode=text]{86401} seconds.
  This pretense leads to application
...
that all days have \num[mode=text]{86400} seconds.
Its values are very different from
...
\num[mode=text]{1778298}\footnote{\href{https://bugzilla.redhat.com/show_bug.cgi?id=1778298}{https://bugzilla.redhat.com/show\_bug.cgi?id=1778298}}
contains my opinion.
...
For example, the TAI integer \num[mode=text]{1483228836} corresponds to
...
that \num[mode=text]{0.5} must be added to get a proper Julian Day Number.
...
the participants.  The string you send should be
{\liningnumbers 2017-06-30T00:00:00Z}.
...
scheduled backup will be at
{\liningnumbers 2017-01-03T08:00:00Z}.
...
\embedfile[desc={Example code for rocket over Central Park},
  mimetype={text/plain},
  ucfilespec={examples/example\_03.c}]{examples/example_03.c}

Here is the schedule for 2016:

\begin{center}
  \VerbatimInput[formatcom=\liningnumbers]{example_03_output.txt}
\end{center}
\embedfile[desc={Output of example 3},
  mimetype={text/plain},
  ucfilespec={example\_03\_output.txt}]{example_03_output.txt}
...
\num[mode=text]{63072010} seconds before January 1, 1972 at 00:00:00 UTC.
That definition
...
PTP times \num[mode=text]{15638408} and \num[mode=text]{47174409} correspond
to the leap seconds that are needed to keep a count of fixed-length seconds
...
the present.  Prior to 1825 the measurements become uncertain.
...
the year 2500 based on the latest research on the rotation
of the Earth.
...
1825 or more than six months in the future, you should recompute
...
\item Add a named clock, called {\ttfamily CLOCK\_UTC}, which uses
  ...
  \num[mode=text,retain-unity-mantissa = false]{1e9} added to
...
\begin{description}
\item[2026-02-13 5.198.2]Adjust future leap seconds starting in 2090.
\item[2026-01-23 5.197.2]Adjust future leap seconds starting in 2031.
  The next leap second is predicted to be a positive leap second
  on December 31, 2047.
\item[2026-01-16 5.196.2]Adjust future leap seconds starting in 2149.
  Update to IERS Bulletin C 71
  issued January 6, 2026, which states that $\rm{UTC}-\rm{TAI}$
  will remain at \num[mode=text]{-37} seconds for the next six months,
  at least.
\item[2026-01-02 5.195.2]Adjust future leap seconds starting in 2030.
  The next leap second is predicted to be a negative leap second
  on June 30, 2031.
\item[2025-11-28 5.194.2]Adjust future leap seconds starting in 2030.
  The next leap second is predicted to be a negative leap second
  on December 31, 2030.
\item[2025-10-31 5.193.2]Adjust future leap seconds starting in 2067.
\item[2025-09-19 5.192.2]Adjust future leap seconds starting in 2161.
\item[2025-08-22 5.191.2]Adjust future leap seconds starting in 2099.
\item[2025-08-15 5.190.2]Adjust future leap seconds starting in 2029.
  The next leap second is predicted to be a negative leap second
  on June 30, 2030..
\item[2025-07-25 5.189.2]Adjust future leap seconds starting in 2047.
\item[2025-07-18 5.188.2]Adjust future leap seconds starting in 2051.
\item[2025-07-11 5.187.2]Adjust future leap seconds starting in 2224.
  Update to IERS Bulletin C 70,
  issued July 7, 2025, which states that $\rm{UTC}-\rm{TAI}$
  will remain at \num[mode=text]{-37} seconds for the next six months,
  at least.
\item[2025-07-04 5.186.2]Adjust future leap seconds starting in 2150.
\item[2025-06-13 5.185.2]Adjust future leap seconds starting in 2080.
\item[2025-06-06 5.184.2]Adjust future leap seconds starting in 2194.
\item[2025-05-30 5.183.2]Adjust future leap seconds starting in 2029.
  The next leap second is predicted to be a negative leap second
  on December 31, 2029.
\item[2025-05-23 5.182.2]Adjust future leap seconds starting in 2208.
\item[2025-04-04 5.181.2]Adjust future leap seconds starting in 2063.
\item[2025-02-21 5.180.2]Adjust future leap seconds starting in 2063.
\item[2025-01-10 5.179.2]Adjust future leap seconds starting in 2274.
  Update to IERS Bulletin C 69,
  issued January 6, 2025, which states that $\rm{UTC}-\rm{TAI}$
  will remain at \num[mode=text]{-37} seconds for the next six months,
  at least.
\item[2025-01-03 5.178.2]Adjust future leap seconds starting in 2223.
\item[2024-12-27 5.177.2]Adjust future leap seconds starting in 2141.
\item[2024-12-20 5.176.2]Adjust future leap seconds starting in 2097.
\item[2024-11-01 5.175.2]Adjust future leap seconds starting in 2095.
...
\item[2019-07-04 3:6:0]Update to IERS Bulletin C 58, issued July
  ...
  \num[mode=text]{-37} seconds for the next six months, at least.  
